# Onederful Dentistry API Test Node API Library

[![NPM version](https://img.shields.io/npm/v/onederful-dentistry-api-test.svg)](https://npmjs.org/package/onederful-dentistry-api-test) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/onederful-dentistry-api-test)

This library provides convenient access to the Onederful Dentistry API Test REST API from server-side TypeScript or JavaScript.
...
```sh
npm install git+ssh://git@github.com:onederful-dentistry-api/onederful-dentistry-api-test-nodejs.git
```
...
add the following import before your first import `from "OnederfulDentistryAPITest"`:
...
To do the inverse, add `import "onederful-dentistry-api-test/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/onederful-dentistry-api/onederful-dentistry-api-test-nodejs/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/onederful-dentistry-api/onederful-dentistry-api-test-nodejs/issues) with questions, bugs, or suggestions.
